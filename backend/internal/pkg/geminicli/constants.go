...
const (
	...
	// GeminiCLIOAuthClientID/Secret are intentionally empty in source. Configure them
	// via GEMINI_CLI_OAUTH_CLIENT_ID / GEMINI_CLI_OAUTH_CLIENT_SECRET if you want
	// to enable the Code Assist OAuth flow without a custom OAuth client.
