export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportFormat: 'Import Format',
      sub2apiImportFormat: 'Sub2API export data',
      sub2apiImportFormatHint: 'Import exported account and proxy JSON files.',
      cliProxyAuthImportFormat: 'CLIProxyAPI auth/token',
      cliProxyAuthImportFormatHint: 'Supports auth JSON, JSON arrays, and JSON Lines.',
      cliProxyAuthImportWarning: 'Deduplicates by refresh token, account ID, or email. Existing accounts are updated by default while panel usage records are preserved.',
      cliProxyAuthImportFileHint: 'JSON / JSON Lines (.json, .txt)',
      cliProxyAuthImportResultSummary: 'Total {total}, created {created}, updated {updated}, skipped {skipped}, failed {failed}',
      cliProxyAuthImportSuccess: 'CLIProxyAPI import completed: created {created}, updated {updated}, skipped {skipped}',
      cliProxyAuthImportPartial: 'CLIProxyAPI import partially completed: created {created}, updated {updated}, skipped {skipped}, failed {failed}',
