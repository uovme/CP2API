export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportFormat: '导入格式',
      sub2apiImportFormat: 'Sub2API 导出数据',
      sub2apiImportFormatHint: '导入账号与代理导出的 JSON 文件。',
      cliProxyAuthImportFormat: 'CLIProxyAPI auth/token',
      cliProxyAuthImportFormatHint: '支持 auth JSON、JSON 数组和 JSON Lines。',
      cliProxyAuthImportWarning: '会按 refresh token、账号 ID 或邮箱去重；默认更新已有账号并保留面板用量统计。',
      cliProxyAuthImportFileHint: 'JSON / JSON Lines (.json, .txt)',
      cliProxyAuthImportResultSummary: '总计 {total}，新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      cliProxyAuthImportSuccess: 'CLIProxyAPI 导入完成：新增 {created}，更新 {updated}，跳过 {skipped}',
      cliProxyAuthImportPartial: 'CLIProxyAPI 导入部分成功：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
      dataImportFile: '数据文件',
