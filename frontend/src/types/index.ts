...
export interface CLIProxyAuthImportRequest {
  content?: string
  contents?: string[]
  name?: string
  notes?: string | null
...
export interface CLIProxyAuthImportMessage {
  index: number
  name?: string
  message: string
}

export interface CLIProxyAuthImportItem {
  index: number
  name?: string
  action: 'created' | 'updated' | 'skipped' | 'failed'
  account_id?: number
...
export interface CLIProxyAuthImportResult {
  total: number
  created: number
  updated: number
  skipped: number
  failed: number
  items?: CLIProxyAuthImportItem[]
  warnings?: CLIProxyAuthImportMessage[]
  errors?: CLIProxyAuthImportMessage[]
}
